...
i18nStrings.zh = {
    ...
    cards: {
        standard: {
            ...
            ex: {
                ...
                pickit: {
                    name: "挑卡助手尊享版",
                    desc: "解锁尊享版排序功能：按最低升级成本排序并过滤不可升级卡，但有时限。",
    ...
    skills: {
        ...
        leaf: {
            name: "肥料",
            desc: "在下次{draw}中，每提高一级稀有度增加所有碎片倍率{0}。",
        },
        sun: {
            name: "光合作用",
