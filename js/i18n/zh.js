        ...
        standard: {
            ...
            sr: {
                ...
                n6a: {
                    ...
                    quote: "很显然向玩家狂轰滥炸广告超过某个程度，就会适得其反把人吓跑。也许我们该减少点广告？"
                },
                c1: {
                    name: "pick-it",
                    desc: "解锁按某些标准筛选卡牌的能力。",
                    quote: "使用pick-it™你可以按任何能想到的条件筛选卡牌！...不过按人气排序需要订阅月度高级会员"
                }
            },
            ssr: {
                n0: {
                ...
                s_water_2: {
                    name: "山顶",
                    desc: "<b>冻结滴落</b>激活且达到能量上限时{+1%}卡牌倍数。<b>冻结滴落</b>的能量上限提升效果加强{+0%}。",
                    quote: "🍓"
                },
                s_leaf: {
                    name: "肥料",
